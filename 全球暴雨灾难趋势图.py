...
storm_data = data[data['Disaster Type'] == 'Storm']#筛选洪涝灾难的数据
print(storm_data)
storm_count = storm_data.groupby('Year').size()#按年份统计数量
print(storm_count)
x= np.array(['2010','2011','2012','2013','2014','2015',
             '2016','2017','2018','2019','2020','2021'])
y = storm_count.tolist()[10:22]#将size()统计后的数据转换为列表并取11行到21行
print(y)
plt.plot(x, y)
plt.xlabel('年份')
plt.ylabel('总频次')
plt.title('2010-2021全球暴雨灾难趋势图')
plt.show()